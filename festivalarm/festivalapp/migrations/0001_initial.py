    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kakao_id', models.CharField(blank=True, max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('festival', models.ForeignKey(db_column='festival_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_festsival', to='festivalapp.festival')),
            ],
        ),
        migrations.CreateModel(
            name='OptionCount',
            fields=[
                ('festival', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='option_count', serialize=False, to='festivalapp.festival')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_id', models.ForeignKey(db_column='post_id', on_delete=django.db.models.deletion.CASCADE, related_name='post_images', to='festivalapp.post')),
            ],
            options={
                'db_table': 'post_image',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_url', models.CharField(blank=True, max_length=200)),
                ('festival_id', models.ForeignKey(db_column='festival_id', on_delete=django.db.models.deletion.CASCADE, related_name='festival_images', to='festivalapp.festival')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(db_column='post_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comment_post', to='festivalapp.post')),
            ],
        ),
    ]
